...
wget -O /tmp/dev.zip https://github.com/midoks/mdserver-web/archive/refs/heads/mysql-ya.zip
cd /tmp && unzip /tmp/dev.zip
cp -rf /tmp/mdserver-web-mysql-ya/* /www/server/mdserver-web
rm -rf /tmp/dev.zip
rm -rf /tmp/mdserver-web-mysql-ya
