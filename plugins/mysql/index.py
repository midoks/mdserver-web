...
def doFullSyncUser(version=''):
    ...
    if not os.path.exists(bak_file):
        # 不锁表导出
        dump_sql_data = getServerDir() + "/bin/mysqldump " + dmp_option + " --single-transaction --master-data=1 --apply-slave-statements --include-master-host-port --compress -E -R -q -c --default-character-set=utf8mb4 -h" + ip + " -P" + \
